...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ZFNetWorkModule"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of NetWorkModule."

  spec.homepage     = "https://github.com/SuperHaiFeng/ZFNetWorkModule"
  ...
  spec.source       = { :git => "https://github.com/SuperHaiFeng/ZFNetWorkModule.git", :tag => "#{spec.version}" }
  ...
  if spec.version.to_s.include?'Binary'
    ...
    spec.source_files = "ZFNetWorkModule/Classes", "ZFNetWorkModule/Classes/**/*"
  end
  ...
  spec.dependency "ZFCommonModule", '~> 0.0.3'
